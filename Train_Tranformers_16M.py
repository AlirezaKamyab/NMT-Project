...
train_writer = tf.summary.create_file_writer(logdir='./logs/16M/train')
test_writer = tf.summary.create_file_writer(logdir='./logs/16M/test')
...
### Save the translator
transformer.save('./models/transformers16M.tf')
